...
var Builder = class {
   ...
   * @param collections
   */
  buildCollectionDefinition = async (collections) => {
   ...
   * @param collections
   */
  buildMultiCollectionDefinition = async (collections) => {
   ...
   * @param collections
   */
  multiCollectionDocument = async (collections) => {
    const name = "document";
    const args = [
      astBuilder.InputValueDefinition({
        name: "collection",
   ...
   * @param collections
   */
  addMultiCollectionDocumentMutation = async () => {
    return astBuilder.FieldDefinition({
   ...
   * @param collections
   */
  buildCreateCollectionDocumentMutation = async (collections) => {
    return astBuilder.FieldDefinition({
      name: "createDocument",
      args: [
        astBuilder.InputValueDefinition({
   ...
   * @param collections
   */
  buildUpdateCollectionDocumentMutation = async (collections) => {
    return astBuilder.FieldDefinition({
      name: "updateDocument",
      args: [
        astBuilder.InputValueDefinition({
   ...
   * @param collections
   */
  buildDeleteCollectionDocumentMutation = async (collections) => {
    return astBuilder.FieldDefinition({
      name: "deleteDocument",
      args: [
        astBuilder.InputValueDefinition({
   ...
   * @param collections
   */
  buildCreateCollectionFolderMutation = async () => {
    return astBuilder.FieldDefinition({
      name: "createFolder",
      args: [
        astBuilder.InputValueDefinition({
   ...
   * @param collection
   */
  collectionDocument = async (collection) => {
  ...
  authenticationCollectionDocument = async (collection) => {
  ...
  updatePasswordMutation = async (collection) => {
    return astBuilder.FieldDefinition({
      type: astBuilder.TYPES.Boolean,
      name: "updatePassword",
      required: true,
  ...
  authorizationCollectionDocument = async (collection) => {
   ...
   */
  collectionFragment = async (collection) => {
   ...
   *
   * */
  _getCollectionFragmentSelections = async (collection, depth) => {
    const selections = [];
    selections.push({
   ...
   * @param collection
   */
  updateCollectionDocumentMutation = async (collection) => {
    return astBuilder.FieldDefinition({
   ...
   * @param collection
   */
  createCollectionDocumentMutation = async (collection) => {
    return astBuilder.FieldDefinition({
      type: await this._buildCollectionDocumentType(collection),
   ...
   * @param collection
   */
  collectionDocumentList = async (collection) => {
   ...
   */
  buildStaticDefinitions = () => staticDefinitions;
  _buildCollectionDocumentType = async (collection, suffix = "", extraFields = [], extraInterfaces = []) => {
  ...
  _buildAuthDocumentType = async (collection, suffix = "", extraFields = [], extraInterfaces = []) => {
  ...
  _filterCollectionDocumentType = async (collection) => {
  ...
  _buildTemplateFilter = async (template) => {
    const fields = [];
  ...
  _updateCollectionDocumentMutationType = async (collection) => {
    const t = this.tinaSchema.getTemplatesForCollectable(collection);
    if (t.type === "union") {
      return astBuilder.InputObjectTypeDefinition({
  ...
  _buildTemplateMutation = async (template) => {
    return astBuilder.InputObjectTypeDefinition({
  ...
  _buildMultiCollectionDocumentDefinition = async ({
    fieldName,
    collections,
    includeFolderType
  }) => {
  ...
  _buildMultiCollectionDocumentListDefinition = async ({
    fieldName,
    namespace,
    nodeType,
    collections,
  ...
  _buildReferenceMutation = async (field) => {
    return astBuilder.InputObjectTypeDefinition({
  ...
  _buildPasswordMutation = async (field) => {
    return astBuilder.InputValueDefinition({
      name: field.name,
      list: field.list,
      type: astBuilder.InputObjectTypeDefinition({
  ...
  _buildUpdateDocumentMutationParams = async (field) => {
  ...
  _buildObjectOrUnionData = async (collectableTemplate, extraFields = [], extraInterfaces = [], collection) => {
  ...
  _connectionFilterBuilder = async ({
    fieldName,
    namespace,
    collection,
    collections
...
`;
  ...
  _buildTemplateData = async ({ namespace, fields }, extraFields = [], extraInterfaces = []) => {
    return astBuilder.ObjectTypeDefinition({
...
var Resolver = class _Resolver {
  ...
  getDocumentOrDirectory = async (fullPath) => {
    if (typeof fullPath !== "string") {
      throw new Error(
  ...
  getDocument = async (fullPath, opts = {}) => {
    if (typeof fullPath !== "string") {
      throw new Error(
        `fullPath must be of type string for getDocument request`
      );
  ...
  buildObjectMutations = async (fieldValue, field, existingData) => {
    if (field.fields) {
  ...
  resolveCollectionConnections = async ({ ids }) => {
    return {
  ...
  referenceResolver = async (filter, fieldDefinition) => {
  ...
  resolveCollectionConnection = async ({
    args,
    collection,
    hydrator
  }) => {
  ...
  buildFieldMutations = async (fieldParams, template, existingData) => {
    const accum = {};
...
var Database = class {
  ...
  _lookup;
  collectionForPath = async (filepath) => {
  ...
  addPendingDocument = async (filepath, data) => {
    await this.initLevel();
  ...
  put = async (filepath, data, collectionName) => {
    await this.initLevel();
    try {
      if (SYSTEM_FILES.includes(filepath)) {
  ...
  formatBodyOnPayload = async (filepath, data) => {
    const collection = await this.collectionForPath(filepath);
    if (!collection) {
  ...
  stringifyFile = async (filepath, payload, collection) => {
  ...
  getGraphQLSchemaFromBridge = async () => {
    if (!this.bridge) {
  ...
  getSchema = async (level, existingSchema) => {
    if (this.tinaSchema) {
  ...
  getCollectionReferences = async (level) => {
  ...
  getIndexDefinitions = async (level) => {
  ...
  query = async (queryOptions, hydrator) => {
    await this.initLevel();
    const {
      first,
      after,
  ...
  deleteContentByPaths = async (documentPaths) => {
    await this.initLevel();
    const operations = [];
  ...
  _indexAllContent = async (level, schema) => {
